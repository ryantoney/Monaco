...
var LuaHighlightRules = function () {
    ...
    var functions = ( // MakeSureDudeDies - i got rid of os, file, io and package i also added some functions but uhh not all 
	"string|xpcall|tostring|print|error|warn|unpack|require|" +
        "getfenv|getgenv|getsenv|getrenv|getregistry|getreg|getfenv|setmetatable|next|assert|tonumber|rawequal|" +
        "collectgarbage|getmetatable|module|rawset|math|debug|" +
        "pcall|table|newproxy|type|coroutine|_G|select|gcinfo|" +
        "pairs|rawget|loadstring|ipairs|_VERSION|dofile|setfenv|" +
        "load|loadfile|" +
	"getnilinstances|getgc|getconnections|gethui|getmodules|getscripts|getscriptbytecodegetclipboard|" +
	"setfflag|setidentity|setclipboard|setreadonly|" +
	"writefile|readfile|hookfunction|hookmetamethod|decompile|saveinstance|" +
	"printidentity|rconsoleprint|" +
	"isluau|" +
	"GetChildren|GetDescendants|GetObjects|GetFullName|Connect|Clone|Destroy|AddTag|ClearAllChildren|FindFirstAncestor|FindFirstAncestorOfClass|FindFirstAncestorWhichIsA|FindFirstChild|FindFirstChildOfClass|FindFirstChildWhichIsA|FindFirstDescendant|GetActor|GetAttribute|GetAttributeChangedSignal|GetAttributes|GetDebugId|GetPropertyChangedSignal|GetTags|HasTag|IsA|IsAncestorOf|IsDescendantOf|RemoveTag|SetAttribute|WaitForChild|HttpGet|" +
        "sub|upper|len|gfind|rep|find|match|char|dump|gmatch|" +
        "reverse|byte|format|gsub|lower|preload|loadlib|loaded|" +
        "ldexp|pi|cos|tanh|pow|deg|tan|cosh|sinh|random|randomseed|log|max|acos|huge|" +
        "frexp|ceil|floor|rad|abs|sqrt|modf|asin|min|mod|fmod|log10|" +
        "atan2|exp|sin|atan|getupvalue|debug|sethook|getmetatable|" +
        "gethook|setmetatable|setlocal|traceback|setfenv|getinfo|" +
        "setupvalue|getlocal|setn|insert|getn|" +
        "foreachi|maxn|foreach|concat|sort|remove|resume|yield|" +
        "status|wrap|create|running|" +
        "__add|__sub|__mod|__unm|__concat|__lt|__index|__call|__gc|__metatable|" +
        "__mul|__div|__pow|__len|__eq|__le|__newindex|__tostring|__mode|__tonumber");
    var stdLibaries = ("string|math|debug|table|coroutine");
